...
export type Place = {
  ...
  imageUrl?: string;
  /** هل يمكن حجز هذا المكان؟ (يتحكم به الأدمن لكل مكان على حدة) */
  bookable?: boolean;
  /** سعر الحجز بالريال السعودي (اختياري — 0 تعني أن السعر غير محدد). */
  price?: number;
  /** رابط حجز خارجي اختياري (موقع المطعم/الجهة نفسها) — مستقل عن الحجز الداخلي. */
  bookingUrl?: string;
};
